...
public class FirebaseUsersRegisterTest {
    ...
    public void Login_NonEmpty() {
        onView(withId(R.id.edit_text_email_register)).perform(typeText(mEmail), closeSoftKeyboard());
        onView(withId(R.id.edit_text_password_register)).perform(typeText(mPassword), closeSoftKeyboard());
    ...
    public void Login_Password() {
        onView(withId(R.id.edit_text_email_register)).perform(typeText(mEmail), closeSoftKeyboard());
        onView(withId(R.id.edit_text_password_register)).perform(typeText(shortPassword), closeSoftKeyboard());
        onView(withId(R.id.button_register)).perform(click());
    }
