...
public class UserTest {
    ...
    private final static ArrayList<String> DUMMY_CREATED_ACTIVITIES_ID = new ArrayList<String>();
    ...
    public void userConstructorFailsIfFullNameNull() {
        User user = new User(null, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test(expected = IllegalArgumentException.class)
    public void userConstructorFailsIfEmailNull() {
        User user = new User(DUMMY_FULL_NAME, null, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test(expected = IllegalArgumentException.class)
    public void userConstructorFailsIfPhoneNull() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, null, DUMMY_DESCRIPTION, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test(expected = IllegalArgumentException.class)
    public void userConstructorFailsIfUserIdNull() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, null, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test(expected = IllegalArgumentException.class)
    public void userConstructorFailsIfPhoneNumberNull() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, null, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test(expected = IllegalArgumentException.class)
    public void userConstructorFailsIfFullNameNullLongConstructor() {
        User user = new User(null, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test(expected = IllegalArgumentException.class)
    public void userConstructorFailsIfEmailNullLongConstructor() {
        User user = new User(DUMMY_FULL_NAME, null, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    }

    @Test
    public void userGetFullName() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userGetUserId() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userGetCreatedActivitiesId() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        assertEquals(DUMMY_CREATED_ACTIVITIES_ID, user.getCreatedActivitiesId());
    }
    ...
    public void userAddCreatedActivityCorrect() {
        ...
        assertEquals(2, user.getCreatedActivitiesId().size());
    }
    ...
    public void userRemoveCreatedActivityCorrect() {
        ...
        assertEquals(1, user.getCreatedActivitiesId().size());
    }

    @Test
    public void userRemoveRegisteredActivityCorrect() {
        User user = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, new ArrayList<String>());
    ...
    public void userEqualCorrect() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userEqualDifferentUser1() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User("Georges", DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userEqualDifferentUser2() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User(DUMMY_FULL_NAME, "CANDEA", DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userEqualDifferentUser3() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, "231233564321", DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userEqualDifferentUser4() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, "description_2", DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userEqualDifferentUser5() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, "id", DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
    ...
    public void userEqualDifferentUser6() {
        User user1 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, DUMMY_IMAGE_ID, DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
        User user2 = new User(DUMMY_FULL_NAME, DUMMY_EMAIL, DUMMY_PHONE_NUMBER, DUMMY_DESCRIPTION, DUMMY_USER_ID, "imageId", DUMMY_DOCUMENT_PATH, DUMMY_CREATED_ACTIVITIES_ID, DUMMY_REGISTERED_ACTIVITIES_ID);
